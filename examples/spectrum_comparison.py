...
kolmogorov = kolmogorov_spectrum(qs, 0, Cn2)
von_karman = von_karman_spectrum(qs, 0, Cn2, L0)
modified_von_karman = modified_von_karman_spectrum(qs, 0, Cn2, L0, l0)
hill_andrews = hill_andrews_spectrum(qs, 0, Cn2, L0, l0)

plt.plot(qs, von_karman / kolmogorov, label="Von Karman")
plt.plot(
    qs, modified_von_karman / kolmogorov, label="Modified Von Karman", linestyle="--"
)
